    ...
    Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'admin']], function () {
        ...
        Route::resource('attendance-notifications', 'AttendanceNotificationsController', ['except' => ['store', 'edit', 'update', 'show', 'destroy']]);

        // Date Sheet Notifications
        Route::resource('date-sheet-notifications', 'DateSheetNotificationController', ['except' => ['store', 'edit', 'update', 'show', 'destroy']]);
        ...
        Route::resource('notifications', 'NotificationController', ['except' => ['index', 'create']]);

        // Result Notifications
        Route::resource('result-notifications', 'ResultNotificationController', ['except' => ['store', 'edit', 'update', 'show', 'destroy']]);
    ...
    Route::get('/download/notice/{url}', 'LandingController@noticeboardDownload')->name('noticeboard.download');
    Route::get('/download/material/{url}', 'LandingController@materialDownload')->name('material.download');
