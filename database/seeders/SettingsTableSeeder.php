...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = [
            ...
            [
                'key'   => 'about_description_first_column',
                'value' => 'Sed nam ut dolor qui repellendus iusto odit. Possimus inventore eveniet accusamus error amet eius aut accusantium et. 
                <ul>
                </i> Ullamco laboris nisi ut aliquip ex ea commodo consequat</li>
                </i> Ullamco laboris nisi ut aliquip ex ea commodo consequat</li>
                </i> Ullamco laboris nisi ut aliquip ex ea commodo consequat</li>
                </ul>
                Non odit consequatur repudiandae sequi ea odio molestiae. Enim possimus sunt inventore in est ut optio sequi unde.'
            ],
            [
                'key'   => 'about_description_second_column',
                'value' => 'Sed nam ut dolor qui repellendus iusto odit. Possimus inventore eveniet accusamus error amet eius aut accusantium et.'
            ],
            [
                'key'   => 'call_to_action_title',
                'value' => 'Call To Action'
            ],
            [
                'key'   => 'call_to_action_description',
                'value' => 'Sed nam ut dolor qui repellendus iusto odit. Possimus inventore eveniet accusamus error amet eius aut accusantium et.'
            ],
            [
                'key'   => 'call_to_action_button_name',
                'value' => 'Call To Action'
            ],
            [
                'key'   => 'call_to_action_button_link',
                'value' => 'https://www.youtube.com/watch?v=jDDaplaOz7Q'
            ],
            [
