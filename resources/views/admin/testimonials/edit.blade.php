    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sying_text') ? 'is-invalid' : '' }}" type="text" name="sying_text" id="sying_text" value="{{ old('sying_text', $testimonial->sying_text) }}" required>
