...
@can('notification_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.date-sheet-notifications.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.dateSheetNotification.title') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.dateSheetNotification.title') }} {{ trans('global.list') }}
    </div>
