...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.instalments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_mehtod') ? 'is-invalid' : '' }}" type="text" name="payment_mehtod" id="payment_mehtod" value="{{ old('payment_mehtod', '') }}">
