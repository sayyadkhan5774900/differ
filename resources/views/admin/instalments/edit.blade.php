...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.instalments.update", [$instalment->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $instalment->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $instalment->amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_mehtod') ? 'is-invalid' : '' }}" type="text" name="payment_mehtod" id="payment_mehtod" value="{{ old('payment_mehtod', $instalment->payment_mehtod) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment') ? 'is-invalid' : '' }}" type="text" name="payment" id="payment" value="{{ old('payment', $instalment->payment) }}">
...
<script>
    ...
    url: '{{ route('admin.instalments.storeMedia') }}',
    maxFilesize: 5, // MB
