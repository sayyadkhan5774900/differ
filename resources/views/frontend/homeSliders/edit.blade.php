    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.home-sliders.update", [$homeSlider->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.homeSlider.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $homeSlider->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="body_text" id="body_text" value="{{ old('body_text', $homeSlider->body_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_link" id="button_link" value="{{ old('button_link', $homeSlider->button_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_name" id="button_name" value="{{ old('button_name', $homeSlider->button_name) }}">
