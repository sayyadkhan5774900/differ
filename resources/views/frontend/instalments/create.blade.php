        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.instalment.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.instalments.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_mehtod" id="payment_mehtod" value="{{ old('payment_mehtod', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment" id="payment" value="{{ old('payment', '') }}">
