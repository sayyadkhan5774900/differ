                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.batches.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="degree_id" id="degree_id" required>
                                @foreach($degrees as $id => $degree)
                                    <option value="{{ $id }}" {{ old('degree_id') == $id ? 'selected' : '' }}>{{ $degree }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="batch_name" id="batch_name" value="{{ old('batch_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="starting_date" id="starting_date" value="{{ old('starting_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="ending_date" id="ending_date" value="{{ old('ending_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="is_active" id="is_active" required>
                                ...
                                @foreach(App\Models\Batch::IS_ACTIVE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_active', 'inactive') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
