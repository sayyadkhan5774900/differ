                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.batches.update", [$batch->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="batch_code" id="batch_code" value="{{ old('batch_code', $batch->batch_code) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="batch_name" id="batch_name" value="{{ old('batch_name', $batch->batch_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="start_time" id="start_time" value="{{ old('start_time', $batch->start_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="end_time" id="end_time" value="{{ old('end_time', $batch->end_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="starting_date" id="starting_date" value="{{ old('starting_date', $batch->starting_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="ending_date" id="ending_date" value="{{ old('ending_date', $batch->ending_date) }}" required>
