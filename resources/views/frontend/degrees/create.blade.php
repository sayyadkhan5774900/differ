    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.degrees.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee" id="fee" value="{{ old('fee', '') }}" step="0.01">
                            @if($errors->has('fee'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fee') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="fee_type" id="fee_type" required>
                                ...
                                @foreach(App\Models\Degree::FEE_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('fee_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
