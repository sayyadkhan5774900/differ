...
class TeamMemeberController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.teamMemebers.index', compact('teamMemebers'));
    }
    ...
    public function store(StoreTeamMemeberRequest $request)
    {
        ...
        return redirect()->route('admin.team-memebers.index');
    }
    ...
    public function edit(TeamMemeber $teamMemeber)
    {
        ...
        return view('admin.teamMemebers.edit', compact('teamMemeber'));
    }
    ...
    public function show(TeamMemeber $teamMemeber)
    {
        ...
        return view('admin.teamMemebers.show', compact('teamMemeber'));
    }
