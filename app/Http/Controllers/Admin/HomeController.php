...
class HomeController
{
    public function index()
    {
        ...
        $settings2 = [
            'chart_title'           => 'Total Fee Collected Last Month',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Instalment',
        ...
        $settings3 = [
            'chart_title'           => 'Total Expense Last Month',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings4 = [
            'chart_title'           => 'Total Income Last Month',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
