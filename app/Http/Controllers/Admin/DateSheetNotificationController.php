...
class DateSheetNotificationController extends Controller
{
    public function index()
    {
        ...
        $notifications = Notification::with(['batch', 'student', 'media'])->where('type','date_sheet')->get();

        return view('admin.dateSheetNotifications.index', compact('notifications'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dateSheetNotifications.create', compact('batches', 'students'));
    }
}
