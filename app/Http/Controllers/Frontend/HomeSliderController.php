...
class HomeSliderController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.homeSliders.index', compact('homeSliders'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.homeSliders.create');
    }
    ...
    public function store(StoreHomeSliderRequest $request)
    {
        ...
        return redirect()->route('frontend.home-sliders.index');
    }
    ...
    public function edit(HomeSlider $homeSlider)
    {
        ...
        return view('frontend.homeSliders.edit', compact('homeSlider'));
    }
    ...
    public function show(HomeSlider $homeSlider)
    {
        ...
        return view('frontend.homeSliders.show', compact('homeSlider'));
    }
